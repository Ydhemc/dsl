...
/**
 * This is the item provider adapter for a {@link roboML.Call} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Call_parameters_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Call_parameters_feature", "_UI_Call_type"),
						RoboMLPackage.Literals.CALL__PARAMETERS, true, false, true, null, null, null));
	}
	...
	protected void addFonctionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Call_fonction_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Call_fonction_feature", "_UI_Call_type"),
						RoboMLPackage.Literals.CALL__FONCTION, true, false, true, null, null, null));
	}
