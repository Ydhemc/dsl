 ...
 * </p>
 * <ul>
 *   <li>{@link roboML.impl.MovementImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetParameters(Expression newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RoboMLPackage.MOVEMENT__PARAMETERS, oldParameters, newParameters);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newParameters != parameters) {
			...
			if (parameters != null)
				msgs = ((InternalEObject) parameters).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RoboMLPackage.MOVEMENT__PARAMETERS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RoboMLPackage.MOVEMENT__PARAMETERS, newParameters,
					newParameters));
	}
